        ...
        <div className="container">
            <div className="row mt-5 mb-5">
                ...
                <div className="col-4 mt-5 mb-5">
                    <h4 className="fs-5 mb-5"><i class="fa fa-plus-circle" aria-hidden="true"></i> Account Opening</h4>
                    ...
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Charges at Stoxura</a><br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Stoxura IDFC FIRST Bank 3-in-1 Account</a><br />
                    <a href="" style={{textDecoration:"none",lineHeight:"2.5"}}>Getting Started</a><br />
                </div>
                <div className="col-4 mt-5 mb-5">
                    <h4 className="fs-5 mb-5"><i class="fa fa-user" aria-hidden="true"></i> Your Stoxura Account</h4>
                ...
                <div className="col-4 mt-5 mb-5">
                    <h4 className="fs-5 mb-5"><i class="fa fa-bar-chart" aria-hidden="true"></i> Your Stoxura Account</h4>
                ...
                <div className="col-4 mt-5 mb-5">
                    <h4 className="fs-5 mb-5"><i class="fa fa-credit-card" aria-hidden="true"></i> Funds</h4>
                ...
                <div className="col-4 mt-5 mb-5">
                    <h4 className="fs-5 mb-5"><i class="fa fa-circle-o-notch" aria-hidden="true"></i> Console</h4>
                ...
                <div className="col-4 mt-5 mb-5">
                    <h4 className="fs-5 mb-5"><i class="fa fa-circle-thin" aria-hidden="true"></i> Coin</h4>
