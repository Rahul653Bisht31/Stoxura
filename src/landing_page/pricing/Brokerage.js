        ...
        <div className="container border-top">
            <div className="row p-5 mt-3">
                <div className="col-7 p-4">
                    ...
                    <ul className="text-muted mt-3" style={{lineHeight:"2.8"}}>
                        ...
                        <li>If the account is in debit balance, any other placed will be charged ₹40 per executed insteed of ₹20 per executed order.</li>
                    </ul>
                </div>
                <div className="col-4 p-4">
                    <a href="" style={{textDecoration:"none"}}><h3 className="fs-5 ps-5 ms-5">List of charges</h3></a>
                </div>
            </div>
        </div>
    );
